...
public class WompiService {
    ...
    public Map<String, String> getAcceptanceToken() {
        ...
        Map<String, Object> presignedAcceptance = data != null ? asMap(data.get("presigned_acceptance")) : null;
        String token = presignedAcceptance != null ? (String) presignedAcceptance.get("acceptance_token") : null;
