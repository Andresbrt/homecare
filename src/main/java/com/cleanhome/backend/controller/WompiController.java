...
public class WompiController {
    ...
    public ResponseEntity<?> startPayment(@RequestBody PaymentStartRequest request, Principal principal) {
        ...
        Map<String, Object> data = asMap(tx.get("data"));
    ...
    public ResponseEntity<?> receiveWebhook(@RequestHeader(name = "X-Event-Signature", required = false) String signature,
        ...
        try {
            ...
            Map<String, Object> event = objectMapper.readValue(rawBody, new TypeReference<Map<String, Object>>() {});
            Map<String, Object> data = asMap(event.get("data"));
            Map<String, Object> tx = data != null ? asMap(data.get("transaction")) : null;
